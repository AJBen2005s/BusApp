plugins {
    ...
    id("kotlin-kapt")
    kotlin("plugin.serialization") version "1.8.0" // Use the correct version based on your Kotlin version
...
android {
    ...
    defaultConfig {
        applicationId = "com.example.mywaytransit"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(libs.ui) // UI components
    ...
    kapt (libs.androidx.room.compiler.v250) // For Kotlin
}
